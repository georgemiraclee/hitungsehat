...
const Sidebar = () => {
  ...
  return (
    <aside className='font-Poppins'>
      <div
        className={`fixed left-0 top-0 right-0 z-50 mx-auto grid w-full grid-cols-3 items-center justify-between px-4 py-3 md:mx-0 md:w-72 md:grid-cols-1 md:bg-white md:px-0 md:backdrop-blur-md lg:mix-blend-screen`}
      >
